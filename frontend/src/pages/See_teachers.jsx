...
function See_teachers() {
	return (
		<>
			<div className="mt-4">
				<h1 className=" mb-4 text-1xl font-medium text-center leading-none tracking-tight md:text-3xl xl:text-3xl ">
					Here are some of Our Best Teachers
				</h1>
			</div>
			<div className="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-teal-400 dark:text-gray-800 mt-7 mb-7 ml-7 hover:shadow-custom-hover hover:cursor-pointer">
				<img src="https://i.pinimg.com/474x/4b/59/22/4b5922d22a239def14b8c8fb0e997eb3.jpg" alt="" className="w-35 h-35 mx-auto rounded-full dark:bg-white aspect-square" />
				<div className="space-y-4 text-center divide-y dark:divide-gray-300">
					<div className="my-2 space-y-1">
						<h2 className="text-xl font-semibold sm:text-2xl">Syed Athar Shah</h2>
